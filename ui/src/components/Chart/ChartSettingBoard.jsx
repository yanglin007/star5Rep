...
import {
    PieChartOutlined, BarChartOutlined, LineChartOutlined, QuestionCircleOutlined
...
const lineData = [
    { name: 'year', type: 'string', value: 'year', id: 0, data: ['2013', '2014', '2015', '2016', '2017', '2018'], color: '#9CC5B0', chart: 'line' },
    { name: 'share1', type: 'value', value: 'h', id: 1, data: [40, 80, 20, 120, 140, 50], color: '#C9856B', chart: 'line' },
    { name: 'share2', type: 'value', value: 'd', id: 2, data: [140, 180, 120, 40, 50, 150], color: '#6F9FA7', chart: 'line' },
    { name: 'share3', type: 'value', value: 'n', id: 3, data: [110, 143, 68, 90, 120, 130], color: '#334553', chart: 'line' }
];
const pieData = [
                            ...
                            <Select
                                ...
                                style={{
                                    ...
                                    chartType.map((item, idx) => <Option key={idx} value={item.value}>
                                        {/* <div>
                                            {item.name}
                                            <p style={{ color: '#999', display: 'none' }}>type...</p>
                                            <div className='charIconBox' style={{ display: 'none' }}>
                                                {item.value === 'line' ? <LineChartOutlined /> : ''}
                                                {item.value === 'bar' ? <BarChartOutlined /> : ''}
                                                {item.value === 'pie' ? <PieChartOutlined /> : ''}
                                            </div>
                                        </div> */}
                                    </Option>)
                                }
