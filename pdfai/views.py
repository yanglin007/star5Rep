...
from .llmRequest import parseLLMRequest, llm,generateRules
...
from .uploadFile import uploadFiles1, uploadFiles,upload
...
def generateRule(request):
    return generateRules(request)
